            ...
            <table class="table table-striped">
              ...
              <tbody>
               <?php
                  ...
                  <?php
                        if($row["type"]=='1'){?>
                           <td><a href="mkau.php?id=<?php echo $row["id"]; ?> & t_id=<?php echo $row["type"]; ?>" class="btn btn-danger">
                                    <i class="fa fa-angle-double-right"></i> make user
                                  </a></td>
                            
                     <?php   }else{?>
                            <td><a href="mkau.php?id=<?php echo $row["id"]; ?>& t_id=<?php echo $row["type"]; ?>" class="btn btn-danger">
                                    <i class="fa fa-angle-double-right"></i> make Admin
                                  </a></td>
                   <?php     }
                    ?>
                </tr>
